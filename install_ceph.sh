...
read -p '请输入ceph集群主机名:' ceph_cluster 
read -p '请输入ceph集群网段:' Network_Segment
...
function install_ceph_package { 
    ...
    # 添加网段
    echo "public_netword = ${Network_Segment}" >> ceph.conf 
    # 重新推送配置文件
